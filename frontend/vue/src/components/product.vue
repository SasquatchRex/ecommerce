<template>
  <div class="">
    ...
    <section class="text-gray-400 bg-neutral-950 body-font overflow-hidden -mt-6">
      <div class="" v-if="product">
            ...
            <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              ...
              <div class="flex mt-6 items-center pb-5 border-b-2 border-gray-800 mb-5">
                <div class="flex">
                  ...
                  <button
                    class="border-2 border-gray-800 ml-1 bg-gray-700 rounded-full w-6 h-6 focus:outline-none"></button>
                  <button
                    class="border-2 border-gray-800 ml-1 bg-indigo-500 rounded-full w-6 h-6 focus:outline-none"></button>
                </div>
                <div class="flex ml-6 items-center">
                  <span class="mr-3">Size</span>
                  <div class="relative">
                    <select
                      class="rounded border border-gray-700 focus:ring-2 focus:ring-indigo-900 bg-neutral-950 appearance-none py-2 focus:outline-none focus:border-indigo-500 text-slate-400 pl-3 pr-10">
                      <option>SM</option>
                      <option>M</option>
                      <option>L</option>
                      <option>XL</option>
        ...
        <div class="bg-neutral-950 text-gray-400">
    <div class="text-3xl text-center pt-8">More Products</div>
    <section class="text-gray-400 bg-neutral-950 body-font">
